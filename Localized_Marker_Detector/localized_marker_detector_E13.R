...
ad <- read_h5ad('anndata_objects/interactive/mesen_E13.h5ad')
...
FeaturePlot(object = mesen.seurat, features = "Msx1")
...
saveRDS(knn_result, 'r_env/knn_result_E13.rds')
...
write.csv(res$gene_table, 'r_lmd_result_E13.txt')
