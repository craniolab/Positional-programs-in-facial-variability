...
ad <- read_h5ad('anndata_objects/interactive/mesen_E11.h5ad')
...
saveRDS(knn_result, 'r_env/knn_result_E11.rds')
...
gene_cl_res = ClusterGenes(dist, accu=.7,min_gene = 10,clustering_method = "complete", return_tree = TRUE, deepSplit = 1)
...
write.csv(res$gene_table, 'r_lmd_result_E11.txt')
